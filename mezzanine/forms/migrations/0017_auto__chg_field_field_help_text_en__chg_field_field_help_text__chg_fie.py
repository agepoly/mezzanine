...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Field.help_text_en'
        db.alter_column(u'forms_field', 'help_text_en', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

        # Changing field 'Field.help_text'
        db.alter_column(u'forms_field', 'help_text', self.gf('django.db.models.fields.CharField')(max_length=300))

        # Changing field 'Field.help_text_fr_CH'
        db.alter_column(u'forms_field', 'help_text_fr_CH', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

    def backwards(self, orm):

        # Changing field 'Field.help_text_en'
        db.alter_column(u'forms_field', 'help_text_en', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Field.help_text'
        db.alter_column(u'forms_field', 'help_text', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Field.help_text_fr_CH'
        db.alter_column(u'forms_field', 'help_text_fr_CH', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    ...
    models = {
        u'forms.field': {
            ...
            'help_text': ('django.db.models.fields.CharField', [], {'max_length': '300', 'blank': 'True'}),
            'help_text_en': ('django.db.models.fields.CharField', [], {'max_length': '300', 'null': 'True', 'blank': 'True'}),
            'help_text_fr_CH': ('django.db.models.fields.CharField', [], {'max_length': '300', 'null': 'True', 'blank': 'True'}),
