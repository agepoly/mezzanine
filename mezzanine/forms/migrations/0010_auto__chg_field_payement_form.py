...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Payement.form'
        db.alter_column(u'forms_payement', 'form_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forms.FormEntry']))

    def backwards(self, orm):

        # Changing field 'Payement.form'
        db.alter_column(u'forms_payement', 'form_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forms.Form']))
    ...
    models = {
        ...
        u'forms.form': {
            ...
            'ammount': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
