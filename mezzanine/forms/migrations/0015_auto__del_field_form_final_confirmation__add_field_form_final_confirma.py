...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Form.final_confirmation_email'
        db.add_column(u'forms_form', 'final_confirmation_email',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Form.final_confirmation_email'
        db.delete_column(u'forms_form', 'final_confirmation_email')
