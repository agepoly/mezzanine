...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Form.ammount'
        db.delete_column(u'forms_form', 'ammount')

        # Adding field 'Form.amount'
        db.add_column(u'forms_form', 'amount',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Form.ammount'
        db.add_column(u'forms_form', 'ammount',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Form.amount'
        db.delete_column(u'forms_form', 'amount')
