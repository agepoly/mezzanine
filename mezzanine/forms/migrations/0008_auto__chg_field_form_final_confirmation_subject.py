...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Form.final_confirmation_subject'
        db.alter_column(u'forms_form', 'final_confirmation_subject', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Form.final_confirmation_subject'
        db.alter_column(u'forms_form', 'final_confirmation_subject', self.gf('django.db.models.fields.TextField')())
