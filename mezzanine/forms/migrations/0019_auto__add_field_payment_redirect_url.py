...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Payment.redirect_url'
        db.add_column(u'forms_payment', 'redirect_url',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Payment.redirect_url'
        db.delete_column(u'forms_payment', 'redirect_url')
