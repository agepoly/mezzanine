...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Payment.form'
        db.delete_column(u'forms_payment', 'form_id')

        # Adding field 'Payment.entry'
        db.add_column(u'forms_payment', 'entry',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['forms.FormEntry']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Payment.form'
        raise RuntimeError("Cannot reverse this migration. 'Payment.form' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Payment.form'
        db.add_column(u'forms_payment', 'form',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forms.FormEntry']),
                      keep_default=False)

        # Deleting field 'Payment.entry'
        db.delete_column(u'forms_payment', 'entry_id')
