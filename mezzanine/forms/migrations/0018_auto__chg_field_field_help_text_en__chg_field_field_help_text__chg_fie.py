...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'forms_field', 'help_text_en', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))

        # Changing field 'Field.help_text'
        db.alter_column(u'forms_field', 'help_text', self.gf('django.db.models.fields.CharField')(max_length=400))

        # Changing field 'Field.help_text_fr_CH'
        db.alter_column(u'forms_field', 'help_text_fr_CH', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))
